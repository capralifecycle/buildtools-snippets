...
FROM azul/zulu-openjdk-alpine:11@sha256:6a1fe2ba5be2205f794771464bb967a0733afebf03f40531fbf2c71e8fa81bbe
...
# Using the provided script.
FROM azul/zulu-openjdk-debian:11@sha256:f022ea72047389b7082ddc354515327680e53787179f01a55010be12f9264e08
RUN set -ex; \
    apt-get update; \
