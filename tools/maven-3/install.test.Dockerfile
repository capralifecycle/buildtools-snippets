...
FROM azul/zulu-openjdk-alpine:11@sha256:61c2086d0a42bc4d7f016083c8a4a76b7bec30d1965581b852f372d3ceac93d6
...
# Using the provided script.
FROM azul/zulu-openjdk-debian:11.0.20.1@sha256:807740266ece16fe67f531dc75ec83084e96b39737e4c12598eeb24cb3276cc8
RUN set -ex; \
    apt-get update; \
