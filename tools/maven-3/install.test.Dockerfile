...
FROM azul/zulu-openjdk-alpine:11@sha256:e0d9da48f9f1ba49fbca564c1c29546473924636a0f81fbe4c99bf5b18a900ea
...
# Using the provided script.
FROM azul/zulu-openjdk-debian:11@sha256:8578a385b27ef208b98731100076b6dddf0fa8810bce7e12986738d2cf9b1105
RUN set -ex; \
    apt-get update; \
