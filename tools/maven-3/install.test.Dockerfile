...
FROM azul/zulu-openjdk-alpine:11@sha256:a9a27719c1cfce9fcb13997e9cfd13bf41b8eee364ab07d19d9c8e396a94206e
...
# Using the provided script.
FROM azul/zulu-openjdk-debian:11@sha256:a3383866426bb6fff9bd8519d501be0077e191482581efc2687f84a29754e3b6
RUN set -ex; \
    apt-get update; \
