...
FROM azul/zulu-openjdk-alpine:11@sha256:6d847d6e91c54f497d663916d34ad842a76d0b58eccc026999d4b40b2d1d282d
...
# Using the provided script.
FROM azul/zulu-openjdk-debian:18@sha256:063be06879e5e3b6dd2b408363128e776eda93222b78f64ed37e03cf213ede88
RUN set -ex; \
    apt-get update; \
