...
FROM azul/zulu-openjdk-alpine:11@sha256:2a0ab48fd8744de47db7dd2afc380bf7855c02d7de0cec9e0366274509d91c9b
...
# Using the provided script.
FROM azul/zulu-openjdk-debian:11@sha256:f1328d3bcf981c39a162576fad4d88df4771d959672c9155778584bdd1a2acd7
RUN set -ex; \
    apt-get update; \
